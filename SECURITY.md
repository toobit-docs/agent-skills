...
This project is a **skill definition layer** — Markdown documents that instruct AI agents how to use the `toobit` CLI. The primary attack surfaces are:
